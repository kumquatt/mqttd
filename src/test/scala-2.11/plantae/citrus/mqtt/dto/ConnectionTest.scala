...
class ConnectionTest extends FunSuite {
  ...
  test("encode connect packet") {
    ...
    assert(encodedConnectPacket === Array(16, 67, 0, 4, 77, 81, 84, 84, 4, -26, 117, 48, 0, 9, 99, 108, 105, 101, 110, 116, 95, 105, 100, 0, 13, 116, 101, 115, 116, 87, 105, 108, 108, 84, 111, 112, 105, 99, 0, 15, 84, 101, 115, 116, 87, 105, 108, 108, 77, 101, 115, 115, 97, 103, 101, 0, 2, 105, 100, 0, 8, 112, 97, 115, 115, 119, 111, 114, 100))
    ...
    assert(encodedConnectPacket2 === Array(16, 21, 0, 4, 77, 81, 84, 84, 4, 2, 0, 60, 0, 9, 99, 108, 105, 101, 110, 116, 95, 105, 100))
  }
